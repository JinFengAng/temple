   ...
   <div style="width: 100px;">
	...
	<div style="width: 80%;height: 545px;margin-left: 20%;">
		...
		<div style="width:95%;padding: 20px;height: 480px;border-radius: 5px;">
			<div class="orderBtn" onclick="window.location='match.php'">个人相配 Match Individual</div>
			<div class="orderBtn" onclick="window.location='matchFamily.php'">家庭相配 Match Family</div>
		</div>
	</div>
</body>
</html>