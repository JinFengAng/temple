  ...
  ?> 
        <div class="vertical-orientation" style="float: left; margin-right: 10px;">
              <label style="color: red;">奉为祈福消灾免厄化难生恩迎祥信士</label><br>
                    <?php echo $rows['family_cname'];?>自命 
                    <?php echo $rows['family_cbirthyear']; ?>年 
                    <?php echo $rows['family_cbirthmonth']; ?>月 
                    <?php echo $rows['family_cbirthday']; ?>日 
                    <!-- 时 -->
                  <label style="color: red">敬奉</label>
              <label style="color: red">合上天香  日月上求平安</label>
              <label style="color: red">天命求贵子合</label>
                <span class="todayMonth"></span>
                <span class="todayDay"></span>日
              <label style="color: red">日月天明</label>
                <?php echo $rows['god_name'];?><label style="color: red">保佑</label>
                <label>合家</label><br>
              <label style="color: red;">天上比求呈      生比化难恼星下解</label><br>
              <label style="color: red">一解十灾百难 二解四季恼星  三解百无禁忌</label><br>
              <label style="color: red">四解疮疥跌星 五解官非口舌 六解家宅不安</label><br>
              <label style="color: red">七解水火贼盗 八解日上㐫星  九解不详之兆</label><br> 
              <label style="color: red">十解夫妻不睦 十一解乌立恶卷 十二解百病消除</label>
              <label style="color: red">天师赐福保佑安宁驱邪出引福归堂</label><br>
              <label style="color: red">太上老君急急如律</label><br>
              <span class="todayYear"></span><label style="color: red">年</label> 
              <?php
