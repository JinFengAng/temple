...
<nav id="sidebar">
	...
	<div style="width: 80%;height: 545px;margin-left: 20%;">
		<div style="width: 100%;float: left;height: 50px"><h2 align="center">Invoice</h2></div>
			...
			<table border="1" style="background-color: white;border-collapse:collapse;width: 100%;">
				...
				if ($result->num_rows > 0){
					while($rows = $result->fetch_assoc()){
						echo "<tr>";
						echo "<td>".$rows['mem_cname']."</td>";
						echo "<td>".$rows['mem_phone']."</td>";
						echo "<td>".$rows['mem_address']."</td>";
						echo "<td>".$rows['mem_address1']."</td>";
						echo "<td><a href='insertINV.php?id=".$rows['member_id']."'>
						<span class='editBtn'>Create Invoice</span></a>";
						echo "</tr>";
					}
				}
				?>
