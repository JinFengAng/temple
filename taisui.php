...
<nav id="sidebar">
	...
	<div class="center" style="float: left; padding-left: 250px">
		<div style="width: 100%;float: left;height: 50px"><h2 align="center">太岁</h2></div>
		<div>
			<button style="float: left;" class="button button1" onclick="window.location='selectTaisuiYear.php'">New Taisui 新的太岁</button>
           <br> 
            <button style="float: left;" class="button button1" onclick="window.location='printTaisui.php'">Print 印出</button>
            <br>
            <button style="float: left;" class="button button1" onclick="window.location='editTaisui.php'">Edit Taisui 改的太岁</button>
            <br>
            <button style="float: left;" class="button button1" onclick="window.location='editmonth.php'">Edit Month</button>
        ...
        ?>
    <div>
		<div style="margin:10px 20px;float:left;width: 60%;height:400px;">
			 <table border="1" style="border-collapse:collapse; width: 70%; text-align: center;">
                ...
                <tr>
                    ...
                    <td class="col-2-row-7"></td>
                    <td class="col-3-row-7"></td>
                    <td class="col-4-row-7"></td>
                    <td class="col-5-row-7"></td>
                    <td class="col-6-row-7"></td>
                    <td class="col-7-row-7"></td>
                    <td class="col-8-row-7"></td>
                    <td class="col-9-row-7"></td>
                    <td class="col-10-row-7"></td>
                    <td class="col-11-row-7"></td>
                    <td class="col-12-row-7"></td>
                </tr>
           
		</table>
        
        <br>
        <label>流年正冲太岁，可祈太岁福：</label><br>
        <label>可带水果，糖果，点油灯，祈求值年太岁保佑，岁岁平安。</label><br>

        <label>还愿在当年冬至之前：</label><br>
        <label>携带水果，糖果，清香油或添香油钱，叩谢值太岁，以保平安。（携带收据来还愿）</label>
        <br> 
        <br>
        <br>
        <br>
